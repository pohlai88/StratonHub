...
keywords: ["installation", "node", "guide", "nextjs", "documents"]
---
...
<StepItem title="Git">
You need to have Git installed for version control. Download Git from [here](https://git-scm.com/).
...
- Link your repository and deploy the project.
