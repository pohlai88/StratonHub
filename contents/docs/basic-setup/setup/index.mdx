...
export const feedbackedit = true      // Control to enable/disable feedback functionality
...
If your MDX files are hosted externally, you can configure the project to load documents directly from a remote source. This option can be useful for syncing documentation updates.

```tsx showLineNumbers
export const loadfromgithub = false   // Set to true to load your MDX documents from an external source
```
