...
interface MigrationOptions {
  ...
  auto?: boolean
  databaseName?: string
  apply?: boolean // If true, applies to main branch after testing
}

/**
 * Get the latest migration file from drizzle directory
 */
function getLatestMigration(): string | null {
 ...
 */
async function migrateWithNeon(options: MigrationOptions) {
